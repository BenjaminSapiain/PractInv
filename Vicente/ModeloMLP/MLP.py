...
if __name__ == '__main__':
    ...
    train = pd.read_csv(r"C:\Users\Racc\Desktop\Codes\Práctica\Vicente\ModeloMLP\datasets\1_train.csv", sep=';', delimiter=None, header='infer')
    test = pd.read_csv(r"C:\Users\Racc\Desktop\Codes\Práctica\out.csv", sep=';', delimiter=None, header='infer')
    ...
    for fold in tqdm(range(N_FOLDS)):
        ...
        ckpt_callback = ModelCheckpoint(mode="min", 
                                        monitor="val_loss", 
                                        dirpath=r"C:\Users\Racc\Desktop\Codes\Práctica\Vicente\ModeloMLP\datasets", filename=f'fold_{N_FOLDS}_{fold}')
        ...
        model = model.load_from_checkpoint(str(list(Path(r"C:\Users\Racc\Desktop\Codes\Práctica\Vicente\ModeloMLP\datasets").glob(f'fold_{N_FOLDS}_{fold}*ckpt'))[0]))
        model.eval()
        y_test = list()
        ...
        submission = pd.read_csv(r"C:\Users\Racc\Desktop\Codes\Práctica\Vicente\ModeloMLP\datasets\sample_submission.csv")
